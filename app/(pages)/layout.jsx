            ...
            <Link
              ...
              className={`flex items-center justify-start w-full h-full p-4 gap-2 cursor-pointer ${
                pathname === sub.href || pathname.startsWith(sub.href)
                  ? "bg-gradient-to-br from-primary/70 to-info text-white shadow-md rounded-3xl"
                  : "hover:text-primary"
              }`}
            >
              {sub.title}
    ...
    >
      <Link
        ...
        className={`flex flex-col xl:flex-row items-center justify-center w-14 h-14 p-2 gap-2 rounded-xl ${
          isActive
            ? "bg-gradient-to-br from-primary/70 to-info text-white"
          ...
          <div className="flex flex-col items-center justify-between h-full gap-2 bg-white w-[80%]">
            ...
            <div className="flex items-center justify-center w-full min-h-[72px] p-2 gap-2">
              <Link
                ...
                className="flex items-center justify-start w-full h-full p-2 gap-2 hover:bg-gradient-to-br from-primary/70 to-info hover:text-white hover:shadow-md hover:rounded-3xl"
              >
                <Logout /> ออกจากระบบ
              </Link>
            </div>
