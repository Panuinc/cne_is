  ...
  static async getOrCreateApplyLink(perReqId) {
    const recruit = await RecruitService.createRecruit({
      ...
      recruitDetail: {
        ...
        recruitDetailMaritalStatus: "",
        recruitDetailMilitaryStatus: "",
        recruitDetailOwnCar: "",
        recruitDetailOwnMotorcycle: "",
        recruitDetailHaveCarLicense: "",
        recruitDetailHaveMotorcycleLicense: "",
