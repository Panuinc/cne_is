  ...
  static async getOrCreateApplyLink(perReqId) {
    const recruit = await RecruitService.createRecruit({
      ...
      recruitDetail: {
        ...
        recruitDischarged: "Yes",
        recruitDetailSeriousIllnessOrContagious: "Yes",
        recruitDetailCriminalConvictionOrBankrupt: "Yes",
        recruitDetailIsPregnant: "Yes",
        recruitDetailHasRelativesInCompany: "Yes",
