...
export default function UIRecruitStep1() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col xl:flex-row items-center justify-center w-full p-2 gap-2 border-4 border-danger">
        <div className="flex flex-col items-center justify-center w-full h-48 xl:w-2/12 p-2 gap-2 border-4 border-dark">
          Pic
        </div>
        <div className="flex flex-col items-center justify-center w-full h-full xl:w-10/12 p-2 gap-2 border-4 border-dark">
