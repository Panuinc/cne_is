  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center w-full p-2 gap-2 border-2 border-dark">
        ...
        <div className="flex items-center justify-start w-full h-full p-2 gap-2 border-2 border-dark indent-10">
        ...
        <div className="flex flex-col items-center justify-center w-full h-full p-2 gap-2 border-2 border-dark">
          ...
          <div className="flex flex-col items-center justify-center w-full h-full xl:w-10/12 border-2 border-dark">
            <div className="flex flex-row items-center justify-center w-full h-full font-[600]">
              <div className="flex items-center justify-center w-full p-2 gap-2 border-2 border-dark border-b-2 border-r-1 border-dark">
                วัตถุประสงค์
              </div>
              <div className="flex  items-center justify-center w-full p-2 gap-2 border-2 border-dark border-b-2 border-l-1 border-dark">
                ฐานทางกฏหมาย
              </div>
            </div>
            <div className="flex flex-row items-center justify-center w-full h-full">
              <div className="flex items-start justify-start w-full h-full p-2 gap-2 border-2 border-dark border-b-2 border-r-1 border-dark">
                (1)
              ...
              <div className="flex items-start justify-start w-full h-full p-2 gap-2 border-2 border-dark border-b-2 border-l-1 border-dark">
            ...
            <div className="flex flex-row items-center justify-center w-full h-full">
              <div className="flex items-start justify-start w-full h-full p-2 gap-2 border-2 border-dark border-r-1 border-dark">
                (7) เพื่อการบริหารจัดการด้านสุขอนามัยและความปลอดภัยของท่าน
                และการป้องกันหรือระงับอันตรายต่อชีวิต ร่างกาย หรือสุขภาพของบุคคล
              </div>
              <div className="flex items-start justify-start w-full h-full p-2 gap-2 border-2 border-dark border-l-1 border-dark">
