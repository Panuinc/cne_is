  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center w-full p-2 gap-2">
        <div className="flex flex-col items-end justify-center w-full h-full p-2 gap-2">
          <div className="flex items-center justify-center w-full h-full p-2 gap-2 text-xl font-[600]">
            แบบฟอร์มขอความยินยอม (Consent Form)
          </div>
          <div className="flex items-center justify-start w-full h-full xl:w-[95%] p-2 gap-2 indent-10">
        ...
        <div className="flex flex-col items-end justify-center w-full h-full p-2 gap-2">
          <div className="flex items-center justify-center w-full h-full p-2 gap-2 text-md font-[600] indent-10">
        ...
        <div className="flex flex-col xl:flex-row items-center justify-center w-full h-full p-2 gap-2">
          <div className="flex items-center justify-start w-full h-full p-2 gap-2 text-md font-[600] indent-10">
