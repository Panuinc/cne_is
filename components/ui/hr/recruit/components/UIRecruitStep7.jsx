  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center w-full p-2 gap-2 border-4 border-danger">
        <div className="flex flex-col items-end justify-center w-full h-full p-2 gap-2 border-4 border-warning">
          ...
          <div className="flex items-center justify-start w-full h-full xl:w-[95%] p-2 gap-2 border-2 border-dark">
            ...
            ใช้หรือเปิดเผยให้สอดคล้องกับพระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล
            พ.ศ. 2562 บริษัทฯ
        ...
        <div className="flex flex-col items-end justify-center w-full h-full p-2 gap-2 border-4 border-warning">
          ...
          <div className="flex items-center justify-start w-full h-full xl:w-[90%] p-2 gap-2 border-2 border-dark">
        ...
        <div className="flex flex-col items-end justify-center w-full h-full p-2 gap-2 border-4 border-warning">
          ...
          <div className="flex items-center justify-start w-full h-full xl:w-[90%] p-2 gap-2 border-2 border-dark">
            2.6 ข้อมูลส่วนบุคคลของบุคคลอื่น เช่น ผู้ติดต่อกรณีฉุกเฉิน
            บุคคลอ้างอิง ผู้รับผลประโยชน์ รายละเอียดหรือเอกสารเกี่ยวกับคู่สมรส
            บุตร บิดามารดา พี่น้องร่วมบิดามารดา รายชื่อเครือญาติ ของท่าน
        ...
        <div className="flex flex-col items-end justify-center w-full h-full p-2 gap-2 border-4 border-warning">
          ...
          <div className="flex items-center justify-start w-full h-full xl:w-[95%] p-2 gap-2 border-2 border-dark">
            ...
            อย่างไรก็ตาม เพื่อประโยชน์ในการดำเนินการตามวัตถุประสงค์การเก็บ
            รวบรวม ใช้หรือเปิดเผยตามที่ระบุไว้ข้างต้นผู้สมัคร
        ...
        <div className="flex flex-col items-end justify-center w-full h-full p-2 gap-2 border-4 border-warning">
          ...
          <div className="flex items-center justify-start w-full h-full xl:w-[90%] p-2 gap-2 border-2 border-dark">
            5.2
            แจ้งให้บริษัทฯดำเนินการให้ข้อมูลส่วนบุคคลของตนถูกต้องเป็นปัจจุบัน
            สมบูรณ์ และไม่ก่อให้เกิด ความเข้าใจผิด
          </div>
          <div className="flex items-center justify-start w-full h-full xl:w-[90%] p-2 gap-2 border-2 border-dark">
            5.3 คัดค้านการเก็บรวบรวม ใช้
            หรือเปิดเผยข้อมูลส่วนบุคคลที่เกี่ยวกับตน ที่กฎหมายอนุญาตให้เก็บ
            ได้โดยไม่ต้องได้รับความยินยอมจากเจ้าของข้อมูล
          ...
          <div className="flex items-center justify-start w-full h-full xl:w-[90%] p-2 gap-2 border-2 border-dark">
            5.4 ขอให้บริษัทฯ ระงับการใช้ข้อมูลส่วนบุคคลได้
          ...
          <div className="flex items-center justify-start w-full h-full xl:w-[95%] p-2 gap-2 border-2 border-dark">
            ...
            2562 หรือที่จะมีการแก้ไขเพิ่มเติมใน ภายหน้า
            หรือกฎหมายอื่นได้อนุญาตไว้
          </div>
        </div>
        ...
        <div className="flex flex-col items-end justify-center w-full h-full p-2 gap-2 border-4 border-warning">
          ...
          <div className="flex items-center justify-start w-full h-full xl:w-[95%] p-2 gap-2 border-2 border-dark">
            เมื่อบริษัทฯ ได้รับแจ้งความประสงค์ของผู้สมัครงานตามที่ระบุไว้ในข้อ
            5. แล้ว บริษัทฯ จะดำเนินการ
          ...
          <div className="flex items-center justify-start w-full h-full xl:w-[95%] p-2 gap-2 border-2 border-dark">
            การเพิกถอนความยินยอมของผู้สมัครงาน จะไม่ส่งผลกระทบต่อการเก็บรวบรวม
        ...
        <div className="flex flex-col items-end justify-center w-full h-full p-2 gap-2 border-4 border-warning">
          <div className="flex items-center justify-center w-full h-full p-2 gap-2 border-2 border-dark text-md font-[600]">
